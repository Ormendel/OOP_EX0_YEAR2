...
public class Polynom implements Polynom_able
{
	...
	@Override
	/**
	 * Override into Monom class;
	 * The iterator is helping to move in Polynom_able pair monom, so the polynom will contains all of the new monoms, unsorted.
	 */
	...
	@Override
	/**
	 * Adding one Monom to Polynom
	 * @param m1 - represents a Monom
	 */
	...
	public double root(double x0, double x1, double eps)
	{
		...
		{
			throw new RuntimeException("Wrong input. Try again one more time");
		}
	}
